  ...
  <div>
    <div class="gva-search-box">
      <el-form ref="searchForm" :inline="true" :model="searchInfo">
        ...
        <el-form-item label="API组">
          <el-input v-model="searchInfo.group" placeholder="api组" />
        </el-form-item>
    ...
    <div class="gva-table-box">
      ...
      <el-table :data="tableData" @sort-change="sortChange" @selection-change="handleSelectionChange">
        ...
        <el-table-column align="left" label="API分组" min-width="100" prop="group" sortable="custom" />
        <el-table-column align="left" label="API简介" min-width="150" prop="desc" sortable="custom" />
        <el-table-column align="left" label="请求" min-width="100" prop="method" sortable="custom">
        ...
        <el-table-column align="left" fixed="right" label="操作" width="200">
          <template #default="scope">
            ...
            <el-button icon="delete" type="primary" link @click="api_deleteFunc(scope.row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
...
const onReset = () => searchInfo.value = {}
// 搜索
