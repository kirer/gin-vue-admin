...
const rules = reactive({
  ...
  component: [{ required: true, message: "请输入文件路径", trigger: "blur" }], "meta.title": [{ required: true, message: "请输入菜单展示名称", trigger: "blur" },],
});
...
const addParameter = (form) => {
  if (!form.parameters) { form.parameters = []; }
  form.parameters.push({ type: "query", key: "", value: "", });
};
